...
public class TestSayfasi extends javax.swing.JFrame {
    ...
    public void kaydet(){
        ...
        if(correctAnswer.equals(cevap)){
            JOptionPane.showMessageDialog(this ,"Dogru işte böyle dostum");
        }else{
             JOptionPane.showMessageDialog(this ,"Yanlış yaptın dikkat ett!!!!!");
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("İngilizce Kelime Oyunu");
        setAlwaysOnTop(true);
        ...
        lblSoru.setForeground(new java.awt.Color(28, 15, 69));
        ...
        btnA.setForeground(new java.awt.Color(72, 61, 139));
        ...
        btnB.setForeground(new java.awt.Color(72, 61, 139));
        ...
        btnC.setForeground(new java.awt.Color(72, 61, 139));
        ...
        btnD.setForeground(new java.awt.Color(72, 61, 139));
        ...
        btnSonrakiSoru2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/next.png"))); // NOI18N
        ...
        btnSonrakiSoru2.setBounds(380, 570, 120, 100);

        btnSonrakiSoru.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        btnSonrakiSoru.setForeground(new java.awt.Color(51, 51, 51));
        btnSonrakiSoru.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/done2.png"))); // NOI18N
        ...
        btnSonrakiSoru.setBounds(380, 570, 120, 100);
        ...
        jButton1.setBounds(0, 570, 120, 100);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/test3.jpg"))); // NOI18N
